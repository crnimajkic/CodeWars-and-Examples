 ...
 */
function clearAll() {
  document.querySelector(".meme-img").setAttribute('src', '')
  document.querySelector(".meme-img").style.display = 'none'


  const jokeParag = document.querySelector('.joke-parag')
  jokeParag.innerText = ''

  const quoteparag = document.querySelector('.quote-parag')
  const quoteauthor = document.querySelector('.quote-author')
  quoteparag.innerText = ''
  quoteauthor.innerText = ''

  const riddleparag = document.querySelector('.riddle-parag')
  const riddleanswer = document.querySelector('.riddle-answer')
  riddleparag.innerText = ''
...
function showMeme() {
  ...
  document.querySelector(".meme-img").setAttribute('src', randomMemeUrl)
  document.querySelector(".meme-img").style.display = 'block'
...
function showJoke() {
  ...
  const jokeParag = document.querySelector('.joke-parag')
  jokeParag.innerText = randomJokeText
}
...
function showQuote() {
  ...
  const quoteparag = document.querySelector('.quote-parag')
  const quoteauthor = document.querySelector('.quote-author')
  quoteparag.innerText = randomQuote.quote
...
function showRiddle() {
  ...
  const riddleparag = document.querySelector('.riddle-parag')
  const riddleanswer = document.querySelector('.riddle-answer')
  riddleparag.innerText = randomRiddle.question
...
function revealAnswers() {
  ...
  const riddleanswer = document.querySelector('.riddle-answer')
  if (riddleanswer.innerText === '') {
    alert('No riddle to answer!')
  } else if (riddleanswer.style.display === 'block') {
    alert('Already revealed answer!')
  } else
...
/**
 * This function is used to get random data.  Usage is pre-filled in the functions above already, but here's an explanation of the function anyways.
 *
 * Valid arguments:
 *
